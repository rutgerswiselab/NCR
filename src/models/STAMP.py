...
class STAMP(GRU4Rec):
    ...
    def __init__(self, neg_emb, neg_layer, hidden_size, num_layers, p_layers,
                 label_min, label_max, feature_num, user_num, item_num, u_vector_size, i_vector_size, random_seed, model_path, attention_size):
        self.attention_size = attention_size
        GRU4Rec.__init__(self, neg_emb=neg_emb, neg_layer=neg_layer, hidden_size=hidden_size, num_layers=num_layers,
                         p_layers=p_layers, label_min=label_min, label_max=label_max, feature_num=feature_num,
                         user_num=user_num, item_num=item_num, u_vector_size=u_vector_size, i_vector_size=i_vector_size,
